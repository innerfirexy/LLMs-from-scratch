...
def main(args):
    ...
    # Code as it is used in the main chapter
        ...
        if args.model in model_map:
            CHOOSE_MODEL = model_map[args.model]
        elif args.model in model_configs:
            CHOOSE_MODEL = args.model
        else:
            raise ValueError(
                f"Invalid --model: {args.model}. Choose from: 124M, 355M, 774M, 1558M "
...
if __name__ == "__main__":
    ...
    parser = argparse.ArgumentParser(
        ...
        description="Finetune a GPT model for instruction following"
    )
    parser.add_argument(
        "--test_mode",
        default=False,
    ...
    parser.add_argument(
        ...
        default=0,
        choices=[0, 1],
        help="Whether to mask instruction tokens in the loss. 0=no masking, 1=mask instructions."
    )
    parser.add_argument(
        "--model",
        type=str,
